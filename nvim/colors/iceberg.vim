...
if has('nvim')
  let g:terminal_color_0  = '#1e2132' " #1e2132 BG
  let g:terminal_color_1  = '#e27878' " #e27878 Red
  let g:terminal_color_2  = '#b4be82' " #b4be82 Green
  let g:terminal_color_3  = '#e2a478' " #e2a478 Orange
  let g:terminal_color_4  = '#84a0c6' " #84a0c6 Blue
  let g:terminal_color_5  = '#a093c7' " #a093c7 Purple
  let g:terminal_color_6  = '#89b8c2' " #89b8c2 Cyan
  let g:terminal_color_7  = '#c6c8d1' " #c6c8d1 FG
  let g:terminal_color_8  = '#6b7089' " #6b7089 Comment
  let g:terminal_color_9  = '#e98989' " #e98989 Bold Red
  let g:terminal_color_10 = '#c0ca8e' " #c0ca8e Bold Green
  let g:terminal_color_11 = '#e9b189' " #e9b189 Bold Orange
  let g:terminal_color_12 = '#91acd1' " #91acd1 Bold Blue
  let g:terminal_color_13 = '#ada0d3' " #ada0d3 Bold Purple
  let g:terminal_color_14 = '#95c4ce' " #95c4ce Bold Cyan
  let g:terminal_color_15 = '#d2d4de' " #d2d4de Bold FG
else
